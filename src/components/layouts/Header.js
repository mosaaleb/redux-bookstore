...
const Header = () => {
  ...
  return (
    <div className="bg-white shadow-md font-montserrat">
      <header className="sm:flex sm:justify-between bg-white relative sm:static sm:w-4/5 sm:mx-auto">
        <div className="flex justify-between items-center p-3 sm:px-0">
          <div>
            <a className="font-bold text-blue-600 text-2xl" href="/">
              Bookstore CMS
            </a>
          </div>
          <div>
        ...
        >
          <a
            href="/"
            className="block mt-1 uppercase p-1 px-1 rounded text-gray-700 hover:bg-gray-200 sm:px-1 sm:mx-5 text-sm"
          >
            Books
          </a>
          <a
          ...
          <a
            href="/"
            className="block mt-1 uppercase p-1 px-1 rounded text-blue-600 hover:bg-gray-200 sm:px-1 sm:mx-5 mb-3 sm:mb-0"
          >
